        ...
        <div className="homepage-wrapper">
            <div className="navbar-wrapper">
                <Navbar username={username} apiKey={apiKey} setBounds={setBounds} city={city} setCity={setCity}
                        setCreateFormVisible={setCreateFormVisible} setSavedVisible={setSavedVisible} setAccountVisible={setAccountButton}></Navbar>
            </div>
            <div className="map-wrapper">
                <Map apiKey={apiKey} bounds={bounds} city={city} setBounds={setBounds} setCity={setCity} setCreateFormVisible={setCreateFormVisible}
                     createFormVisible={createFormVisible} setSavedVisible={setSavedVisible} savedVisible={savedVisible} username={username} setAccountVisible={setAccountButton}
                     accountVisible={accountButton}></Map>
            </div>
        </div>
    );
};
