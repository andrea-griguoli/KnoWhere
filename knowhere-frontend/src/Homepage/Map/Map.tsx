...
const Map: React.FC<MapI> = ({apiKey, bounds, city, setBounds,
                                 ...
                                 createFormVisible, setSavedVisible, savedVisible,
                                 username, setAccountVisible, accountVisible}) => {
    ...
    return (
        <div>
            ...
            <div className="map-wrap">
                ...
                {accountVisible && (<Account setAccountButton={setAccountVisible} apiKey={apiKey}/>)}
